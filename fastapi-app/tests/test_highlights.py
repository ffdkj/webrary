...
from app.migrations import ensure_highlights_table


REAL_DB = Path(__file__).resolve().parents[1] / "data" / "webrary.db"


def _copy_schema(tmp_db: Path) -> None:
